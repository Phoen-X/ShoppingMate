...
public class LocationListenerService extends Service implements LocationListener {
  ...
  private void registerUpdatesListener() {
    ...
    boolean gpsEnabled = prefs.getBoolean("pref_gps_on", false);
    if (gpsEnabled) {
  ...
  private void notifyUser() {
    ...
    intent.setFlags(
        Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_REORDER_TO_FRONT | Intent.FLAG_ACTIVITY_SINGLE_TOP);
